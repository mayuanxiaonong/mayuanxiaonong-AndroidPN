...
public final class ServiceManager {
    ...
    public ServiceManager(Context context) {
		...
		String host = sharedPrefs.getString(Constants.XMPP_HOST, null);
		if(host == null) {
			xmppHost = props.getProperty("xmppHost", "127.0.0.1");
			host = xmppHost;
		}
		String port = sharedPrefs.getString(Constants.XMPP_PORT, null);
		if(port == null) {
        ...
        editor.putString(Constants.XMPP_PORT, port);
