...
public class NotificationSettingsActivity extends PreferenceActivity {
    ...
    private PreferenceScreen createPreferenceHierarchy() {
        ...
        EditTextPreference hostPref = new EditTextPreference(this);
        hostPref.setKey(Constants.XMPP_HOST);
        hostPref.setTitle("Host");
        ...
        portPref.setKey(Constants.XMPP_PORT);
        portPref.setTitle("Port");
        ...
        root.addPreference(hostPref);
        root.addPreference(portPref);
